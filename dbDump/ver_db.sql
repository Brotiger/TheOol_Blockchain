...
CREATE TABLE `innodb_buffer_stats_by_schema` (`object_schema` text, `allocated` varchar(11), `data` varchar(11), `pages` bigint, `pages_hashed` bigint, `pages_old` bigint, `rows_cached` decimal(44,0));


CREATE TABLE `innodb_buffer_stats_by_table` (`object_schema` text, `object_name` text, `allocated` varchar(11), `data` varchar(11), `pages` bigint, `pages_hashed` bigint, `pages_old` bigint, `rows_cached` decimal(44,0));


CREATE TABLE `innodb_lock_waits` (`wait_started` datetime, `wait_age` time, `wait_age_secs` bigint, `locked_table` mediumtext, `locked_table_schema` varchar(64), `locked_table_name` varchar(64), `locked_table_partition` varchar(64), `locked_table_subpartition` varchar(64), `locked_index` varchar(64), `locked_type` varchar(32), `waiting_trx_id` bigint unsigned, `waiting_trx_started` datetime, `waiting_trx_age` time, `waiting_trx_rows_locked` bigint unsigned, `waiting_trx_rows_modified` bigint unsigned, `waiting_pid` bigint unsigned, `waiting_query` longtext, `waiting_lock_id` varchar(128), `waiting_lock_mode` varchar(32), `blocking_trx_id` bigint unsigned, `blocking_pid` bigint unsigned, `blocking_query` longtext, `blocking_lock_id` varchar(128), `blocking_lock_mode` varchar(32), `blocking_trx_started` datetime, `blocking_trx_age` time, `blocking_trx_rows_locked` bigint unsigned, `blocking_trx_rows_modified` bigint unsigned, `sql_kill_blocking_query` varchar(32), `sql_kill_blocking_connection` varchar(26));
...
CREATE TABLE `latest_file_io` (`thread` varchar(316), `file` varchar(512), `latency` varchar(11), `operation` varchar(32), `requested` varchar(11));
...
CREATE TABLE `statements_with_full_table_scans` (`query` longtext, `db` varchar(64), `exec_count` bigint unsigned, `total_latency` varchar(11), `no_index_used_count` bigint unsigned, `no_good_index_used_count` bigint unsigned, `no_index_used_pct` decimal(24,0), `rows_sent` bigint unsigned, `rows_examined` bigint unsigned, `rows_sent_avg` decimal(21,0) unsigned, `rows_examined_avg` decimal(21,0) unsigned, `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));
...
CREATE TABLE `x$innodb_buffer_stats_by_schema` (`object_schema` text, `allocated` decimal(43,0), `data` decimal(43,0), `pages` bigint, `pages_hashed` bigint, `pages_old` bigint, `rows_cached` decimal(44,0));


CREATE TABLE `x$innodb_buffer_stats_by_table` (`object_schema` text, `object_name` text, `allocated` decimal(43,0), `data` decimal(43,0), `pages` bigint, `pages_hashed` bigint, `pages_old` bigint, `rows_cached` decimal(44,0));


CREATE TABLE `x$innodb_lock_waits` (`wait_started` datetime, `wait_age` time, `wait_age_secs` bigint, `locked_table` mediumtext, `locked_table_schema` varchar(64), `locked_table_name` varchar(64), `locked_table_partition` varchar(64), `locked_table_subpartition` varchar(64), `locked_index` varchar(64), `locked_type` varchar(32), `waiting_trx_id` bigint unsigned, `waiting_trx_started` datetime, `waiting_trx_age` time, `waiting_trx_rows_locked` bigint unsigned, `waiting_trx_rows_modified` bigint unsigned, `waiting_pid` bigint unsigned, `waiting_query` varchar(1024), `waiting_lock_id` varchar(128), `waiting_lock_mode` varchar(32), `blocking_trx_id` bigint unsigned, `blocking_pid` bigint unsigned, `blocking_query` varchar(1024), `blocking_lock_id` varchar(128), `blocking_lock_mode` varchar(32), `blocking_trx_started` datetime, `blocking_trx_age` time, `blocking_trx_rows_locked` bigint unsigned, `blocking_trx_rows_modified` bigint unsigned, `sql_kill_blocking_query` varchar(32), `sql_kill_blocking_connection` varchar(26));
...
CREATE TABLE `x$latest_file_io` (`thread` varchar(316), `file` varchar(512), `latency` bigint unsigned, `operation` varchar(32), `requested` bigint);
